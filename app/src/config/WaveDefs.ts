...
export const WAVE_DEFS: WaveDef[] = [
  ...
  { units: ['eravager', 'ezephyr', 'ezephyr', 'ebombardier', 'eneedler', 'elegionnaire'], interval: 1.8 },

  // --- Waves 11-20 ---
  { units: ['eember', 'emandible', 'emandible', 'eneedler', 'elegionnaire'], interval: 2.2 },
  { units: ['edigger', 'edigger', 'eravager', 'ezephyr', 'ebombardier'], interval: 2.0 },
  ...
  { units: ['edigger', 'eguardian', 'eravager', 'ezephyr', 'eember', 'eneedler'], interval: 1.8 },
  ...
  { units: ['edigger', 'eember', 'eguardian', 'eravager', 'eravager', 'ebombardier', 'eneedler', 'elegionnaire'], interval: 1.3 },
